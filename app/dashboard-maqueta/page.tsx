...
type DashboardMaquetaProps = {
  searchParams?: {
    calco?: string;
  };
};

export default function DashboardMaqueta({ searchParams }: DashboardMaquetaProps) {
  const showReference = searchParams?.calco !== "0";

  return (
    <main className={`dashboard-preview${showReference ? " with-reference" : ""}`}>
      ...
      <section className="preview-panel" aria-label="Panel de control LAARK">
        <article className="preview-project-card">
          ...
          <div className="preview-project-info">
            ...
            <span className="preview-arrow-next" aria-hidden="true" />
          </div>
        </article>
        ...
        <section className="preview-status-area">
          <div className="preview-status-left">
            ...
            <nav className="preview-menu-grid" aria-label="Secciones del proyecto">
              <a className="preview-menu-item" href="#">
